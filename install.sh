...
pip3 install --break-system-packages rich flask flask-socketio qrcode websockets pillow spidev RPi.GPIO requests 2>/dev/null \
    || pip3 install rich flask flask-socketio qrcode websockets pillow spidev RPi.GPIO requests
