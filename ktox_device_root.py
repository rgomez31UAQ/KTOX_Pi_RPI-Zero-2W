...
ans,*=srp(Ether(dst=‘ff:ff:ff:ff:ff:ff’)/ARP(pdst=tgt),timeout=2,verbose=0,iface=iface)
...
ans,*=srp(Ether(dst=‘ff:ff:ff:ff:ff:ff’)/ARP(pdst=tgt),timeout=2,verbose=0,iface=iface)
tgt_mac=ans[0][1][Ether].src if ans else ‘ff:ff:ff:ff:ff:ff’
ans2,*=srp(Ether(dst=‘ff:ff:ff:ff:ff:ff’)/ARP(pdst=gw),timeout=2,verbose=0,iface=iface)
