...
def draw_ui():
    ...
    draw.text((4,3), "DISTRIBUTED CRACKER", font=font_sm, fill="#FF3333")
    ...
    draw.text((4,56), f"Workers: {len(WORKERS)}", font=font_sm, fill="#FFBBBB")
    draw.text((4,68), f"Found: {found_password[:16]}" if found_password else "Found: --", font=font_sm, fill="#FFBBBB")
