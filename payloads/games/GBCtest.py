#!/usr/bin/env python3
"""
KTOX GBC Injector - Stable Version
==================================
Web ROM uploader + PyBoy on LCD with button controls
"""
...
from payloads._input_helper import get_button   # keep if it works; otherwise replace with direct GPIO
...
def play_game(lcd, rom_path):
    ...
    try:
        ...
        while not pyboy.tick():
            # Direct button mapping (zero-latency)
...
def rom_selector(lcd):
    ...
    while True:
        ...
        btn = get_button(PINS, GPIO) if 'get_button' in globals() else None
        if btn == "DOWN" and roms:
            ...
            return None
        time.sleep(0.12)  # better debounce
