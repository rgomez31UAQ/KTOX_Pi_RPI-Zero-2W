...
Wrapper around the vendored Responder tool at /root/KTOX_Pi/Responder/.
Captures NTLM hashes via poisoning and optionally relays them to a
target host.

Setup / Prerequisites:
  - Requires Responder installed at /root/KTOX_Pi/Responder/.
...
Loot: /root/KTOX_Pi/loot/NTLMRelay/
"""
...
# Constants
# ---------------------------------------------------------------------------
LOOT_DIR = "/root/KTOX_Pi/loot/NTLMRelay"
os.makedirs(LOOT_DIR, exist_ok=True)

RESPONDER_DIR = "/root/KTOX_Pi/Responder"
